...
const projects = [
  {
    ...
    description: 'Confidence-aware hybrid framework for detecting and quantifying hallucinations in LLMs. Three-pillar architecture combining retrieval-based verification, model-intrinsic confidence scoring, and cross-consistency checking with a novel H-Score metric.',
    ...
    status: 'RESEARCH',
    statusColor: ACCENT2,
    link: 'https://github.com/akashgpatil/halucisense',
    year: '2025',
    color: ACCENT2,
  },
  {
    ...
    description: 'Real-time emergency vehicle green corridor system with AI-driven signal sequencing and traffic-weighted Dijkstra routing. Integrated with BBMP traffic signals. Reduces ambulance response time by up to 500ms per intersection.',
    tags: ['Next.js', 'WebSockets', 'Dijkstra', 'BBMP'],
    metrics: [
      { val: '500ms', label: 'Saved per intersection' },
      { val: 'Live', label: 'Deployed on Vercel' },
      { val: 'BBMP', label: 'Signal integration' },
    ],
    status: 'DEPLOYED',
    statusColor: '#22c55e',
  ...
  },
  {
    ...
    description: 'End-to-end ML pipeline for transaction fraud detection using ensemble methods (Random Forest + XGBoost). Trained on 284k transactions with 99.9% class imbalance. Achieves 97% precision with under 0.1% false positive rate in production.',
    tags: ['Scikit-learn', 'XGBoost', 'Python', 'Docker'],
    metrics: [
      { val: '97%', label: 'Precision score' },
      { val: '284k', label: 'Transactions trained' },
      { val: '<0.1%', label: 'False positive rate' },
    ],
    status: 'BUILT',
    statusColor: ACCENT,
    link: 'https://github.com/akashgpatil/fraud-detection',
    year: '2024',
    color: ACCENT,
  },
  {
    ...
    description: 'ML-powered Formula 1 race strategy system using real telemetry data from FastF1 API. Predicts optimal pit stop windows with 78% accuracy. Built interactive dashboards for lap-by-lap performance visualization.',
    tags: ['Python', 'TensorFlow', 'FastF1', 'Pandas'],
    metrics: [
      { val: '78%', label: 'Pit stop accuracy' },
      { val: '22', label: 'Drivers modelled' },
      { val: 'API', label: 'Live telemetry' },
    ],
    status: 'BUILT',
    statusColor: ACCENT,
    link: 'https://github.com/akashgpatil/f1-analytics',
    year: '2024',
    color: ACCENT,
  },
];
